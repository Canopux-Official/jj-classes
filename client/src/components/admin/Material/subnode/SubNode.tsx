...
//       sx={{ cursor: type === 'folder' ? 'pointer' : 'default' }}
//     >
...
//             <TagIcon sx={{ fontSize: 16, color: '#9e9e9e' }} />
//             {tags.map((tag, index) => (
//               <Chip
//                 key={index}
//                 label={tag}
...
//               <AttachFileIcon sx={{ fontSize: 16, color: '#4caf50' }} />
//               <Typography
//                 variant="caption"
//                 sx={{
//                   fontWeight: 600,
...
//                   }}
//                 >
//                   <DriveFileIcon sx={{ fontSize: 14, color: '#5f6368' }} />
//                   <Link
...
//                   }}
//                 >
//                   <LinkIcon sx={{ fontSize: 14, color: '#5f6368' }} />
//                   <Link
...
//                 <Chip
//                   icon={<LinkIcon />}
//                   label={`${referenceDetails.length} Reference${referenceDetails.length > 1 ? 's' : ''}`}
//                   size="small"
//                   sx={{
...
//                 <CalendarIcon sx={{ fontSize: 16, color: '#d32f2f' }} />
...
//             {createdAt && (
//               <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
//                 <CalendarIcon sx={{ fontSize: 16, color: '#5f6368' }} />
