...
// import CardSkeleton, { ClassCardSkeleton, LoadingSpinner } from '../utils/CardSkeleton';
...
//   // Fetch child nodes when the currentNodeId changes
//   useEffect(() => {
...
//     fetchChildNodes();
//   }, [currentNodeId]); // ✅ Only depend on currentNodeId
...
//       if (result.success) {
//         const updatedNodes = [...localNodes, result.data];
...
//   // Helper function to remove node and its children
...
//           <IconButton onClick={handleBackClick} sx={{ color: '#1976d2' }}>
//             <ArrowBackIcon />
//           </IconButton>
...
//             </Typography>
//           )}
//           <Typography sx={{ mt: 2, color: 'warning.main', fontSize: '0.875rem' }}>
