...
//         // If canceled, clean up uploaded files and reset states
//         setFormData((prev) => ({
//           ...prev,
//           fileDetails: prev.fileDetails?.filter((file) => !file.uploadLink),
//         }));
//       }
//       setUploading(false);
//     }
...
//       // Optionally: You can choose to delete uploaded files if needed
//       setFormData((prev) => ({
//         ...prev,
//         fileDetails: prev.fileDetails?.filter((file) => !file.uploadLink),
//       }));
